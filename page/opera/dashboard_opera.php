...
// Prevent caching of this dynamic HTML to avoid showing stale company/theme for operator
...
<head>
    ...
    <title>RH360 - Painel Operador</title>

    <!-- CSS Files -->
    <link rel="stylesheet" href="../../css/global.css">
    <link rel="stylesheet" href="../../css/legacy/dashboard_opera.css">
...
<div class="dashboard-container">
    ...
    <nav class="sidebar">
        <div class="sidebar-header">
            ...
            <p class="subtitle">Painel Operador</p>
        </div>
