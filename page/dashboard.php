...
<!-- Centralized JS entry — implement routing, data injection and event bindings here -->
<script>
    // Lightweight interactions to toggle sections and show current year.
    (function () {
        const yearSpan = document.getElementById('yearSpan');
        if (yearSpan) yearSpan.textContent = new Date().getFullYear();

        // Simple nav binding: elements with data-content switch to matching content-section
