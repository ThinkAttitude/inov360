...
<div id="modalPedido" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <form action="../../api/pedidos/i2_fa.php" method="POST" enctype="multipart/form-data" class="modal-form">
            <div class="form-section">
                ...
                <div class="input-group">
                    ...
                    <select name="responsavel_id" id="responsavel_id">
                        ...
                        $stmt = $conn->prepare("SELECT id, name FROM user WHERE role = 'inter2' AND id != ?");
                        $stmt->execute([$user_id]);
