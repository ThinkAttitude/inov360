...
try {
    ...
    $stmt = $conn->prepare("
        ...
        WHERE u.role IN ('opera', 'inter2', 'inter')
        ORDER BY u.name
    ");
    $stmt->execute();
...
<div class="page-header">
    ...
    <p>Selecione um colaborador para visualizar ou editar a sua ficha pessoal.</p>
</div>
        ...
        <table class="table">
            ...
            <?php foreach ($operadores as $op): ?>
                <tr>
                    ...
                    <td>
                        <button class="btn analisar-ficha-btn" data-user-id="<?= $op["user_id"] ?>">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<?php else: ?>
    <div id="gestao-content">
        <div class="empty-state">
            ...
            <p>Não foram encontrados colaboradores para gerir no sistema.</p>
        </div>
    </div>
<?php endif; ?>
