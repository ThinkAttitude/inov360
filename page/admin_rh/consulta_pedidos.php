...
try {
    ...
    // Pedidos dos subordinados (inter)
    $stmt1 = $conn->prepare("
        SELECT p.*, u.name AS operador_nome, d.name AS decidido_por_nome
        FROM pedidos_ferias p
        JOIN user u ON p.user_id = u.id
        LEFT JOIN user d ON p.decidido_por = d.id
        WHERE p.estado IN ('aprovado', 'rejeitado') AND u.role IN ('inter', 'inter2')
    ...
    <div class="consulta-header">
        <div class="header-left">
            ...
            <div class="header-text">
                ...
                <p>Visualize o histórico de pedidos processados dos Intermédios da sua equipa.</p>
            </div>
        </div>
        ...
        <div class="requests-section">
            <div class="section-header">
                <div class="section-info">
                    ...
                    <h3>Pedidos de Férias / Ausências (Intermédios)</h3>
                </div>
            </div>
            ...
            <?php else: ?>
                <div class="empty-requests">
                    ...
                    <p>Não existem pedidos processados dos Intermédios da sua equipa.</p>
                </div>
            <?php endif; ?>
        </div>
    </div>
