...
try {
    ...
    $stmt_pedidos = $conn->prepare("
        ...
        WHERE estado = 'pendente' AND user_id IN (
            SELECT id FROM user WHERE role = 'inter'
        )
        GROUP BY user_id
    ");
    ...
    <div class="operadores-header">
        ...
        <div class="header-stats">
            <div class="stat-card">
                ...
                <div class="stat-label">Total Intermedios</div>
            </div>
            <div class="stat-card">
                                ...
                                <td>
                                    <div class="table-user">
                                        ...
                                        <div class="table-user-info">
                                            ...
                                            <div class="table-user-role">Intermedio</div>
                                        </div>
                                    </div>
                                </td>
...
<script>
    // Funcionalidades standalone para lista de intermedios 2
    ...
    function verFichaCompleta(userId) {
        ...
        // Load content - corrigido para usar o diretório admin
