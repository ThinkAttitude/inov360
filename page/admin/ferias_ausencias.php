...
<div id="modalPedido" class="modal-overlay" style="display: none;">
    <div class="modal-container">
        ...
        <form action="../../api/pedidos/a_fa.php" method="POST" enctype="multipart/form-data" class="modal-form">
            <div class="form-section">
                ...
                <div class="input-group">
                    ...
                    <select name="responsavel_id" id="responsavel_id">
                        ...
                        $stmt_users_resp = $conn->prepare("SELECT id, name FROM user WHERE role = 'admin' AND id != ?");
                        $stmt_users_resp->execute([$user_id]);
                        while ($row = $stmt_users_resp->fetch()):
                            ?>
