...
const SVG_ICONS = {
    ...
    ARROW_RIGHT: `<polyline points="9,18 15,12 9,6"></polyline>`
};
...
const CARD_DEFS = {
    ...
    [CARD_TYPES.FICHA_COLLAB]: {
        ...
        dataContent: CARD_TYPES.FICHA_COLLAB,
        ctaText: 'Ver Ficha'
    },
};
...
export function addCardsToWelcomeArea(requested = []) {
    ...
    wc.insertBefore(frag, document.getElementById(CARD_TYPES.FICHA_COLLAB))
    bindNav();
}
